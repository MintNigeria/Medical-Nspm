<div class="modal fade bd-example-modal-lg text-black-50" id="mgmtModal{{ $management->id }}" data-target=".bd-example-modal-lg" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
